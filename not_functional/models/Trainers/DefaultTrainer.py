...
import not_functional.models.utils.BasicUtils
from not_functional.models.Trainers.TrainingUtility import TrainingUtility
# from models.GANSelector import epochs, batch_size, latent_dim, epochs_per_sample, lmbda, output_dir, arguments
# my modules
from not_functional.models.architectures import wave_gan_utils
from not_functional.models.losses.BaseLoss import wassertein_loss
from not_functional.models.utils.BasicUtils import get_params
from not_functional.models.utils.BasicUtils import require_net_update, numpy_to_var, calc_gradient_penalty, \
...
class DefaultTrainer:
    def __init__(self, generator, discriminator, gen_optimizer, dis_optimizer, GAN, data_loader=None,
        ...
        self.sample_noise = not_functional.models.utils.BasicUtils.sample_noise(arguments, latent_dim, device)
